...
import com.example.firebaselogin.fragments.view_by_graph
import com.example.firebaselogin.fragments.view_by_table_fragment
...
class ViewingActivity : AppCompatActivity() {
    ...
    private fun setUpTabs() {
        ...
        adapter.addFragment(view_by_table_fragment(),"Table")
        adapter.addFragment(view_by_graph(),"Graph")
        viewPag.adapter=adapter
        binding.tabs.setupWithViewPager(viewPag)
        binding.tabs.getTabAt(0)!!.setIcon(R.drawable.ic_baseline_table_rows_24)
        binding.tabs.getTabAt(1)!!.setIcon(R.drawable.ic_baseline_bar_chart_24)
